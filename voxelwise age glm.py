...
covariate_df = pd.read_csv('/home/jason/Study_data/Down Syndrome/TRCDS/DSCHOL_dems.csv')
...
thresholded_map_np_ni_sex = new_img_like('DST3050001/swFEOBV.nii', thresholded_map_np_sex)
