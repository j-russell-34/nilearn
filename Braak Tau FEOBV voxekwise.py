...
corr_brainb12 = np.where(brainmask, correlations_b12, np.nan)
corr_brainb34 = np.where(brainmask, correlations_b34, np.nan)
corr_brainb56 = np.where(brainmask, correlations_b56, np.nan)
...
coef_masked_b12 = np.where(bin_p_values_b12, correlations_b12, np.nan) 
coef_masked_b34 = np.where(bin_p_values_b34, correlations_b34, np.nan) 
coef_masked_b56 = np.where(bin_p_values_b56, correlations_b56, np.nan)     
